...
namespace OpenSage.Diagnostics.AssetViews
{
    ...
    internal sealed class ModelView : AssetView
    {
        ...
        public ModelView(DiagnosticViewContext context, Model model)
            : base(context)
        {
            _modelInstance = AddDisposable(model.CreateInstance(context.Game.AssetStore.LoadContext.GraphicsDevice, context.Game.AssetStore.LoadContext.StandardGraphicsResources));
