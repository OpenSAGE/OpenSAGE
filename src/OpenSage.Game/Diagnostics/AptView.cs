...
internal sealed class AptView : DiagnosticView
{
    ...
    protected override void DrawOverride(ref bool isGameViewFocused)
    {
        ...
        {
            ImGui.BeginChild("DisplayLists", new Vector2(400, 0), ImGuiChildFlags.Borders, ImGuiWindowFlags.HorizontalScrollbar);
                ...
                switch (_selectedItem)
                {
                    ...
                    case RenderItem ri:
                        if (_selectedItem.Character is Text)
                        {
                            ...
                            ImGuiUtility.PropertyRow("LocalizedContent", ri.TextValue?.Localize() ?? "null");
