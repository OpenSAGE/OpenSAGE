...
{
    public abstract class DebuggablePoint : IDebuggablePoint
    {
        ...
        protected DebuggablePoint(Vector3 position) : this(position, ColorRgbaF.Blue) { }

        protected DebuggablePoint(Vector3 position, ColorRgbaF displayColor)
        {
            Position = position;
        ...
        public virtual Rectangle GetBoundingRectangle(CameraComponent camera)
        {
            var worldBounds = _bounds.Transform(_transform.Matrix);
