...
partial class ScriptActions
{
    ...
    public static void IncrementCounter(ScriptExecutionContext context, [ScriptArgumentType(ScriptArgumentType.Counter)] string counterName, int incrementBy)
    {
    ...
    public static void DecrementCounter(ScriptExecutionContext context, [ScriptArgumentType(ScriptArgumentType.Counter)] string counterName, int decrementBy)
    {
    ...
    public static void SetCounter(ScriptExecutionContext context, [ScriptArgumentType(ScriptArgumentType.Counter)] string counterName, int value)
    {
    ...
    public static void SetTimer(ScriptExecutionContext context, [ScriptArgumentType(ScriptArgumentType.Counter)] string timerName, int frames)
    {
    ...
    public static void SetMillisecondTimer(ScriptExecutionContext context, [ScriptArgumentType(ScriptArgumentType.Counter)] string timerName, float duration)
    {
