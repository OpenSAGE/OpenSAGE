...
partial class ScriptActions
{
    ...
    public static void MusicSetTrack(ScriptExecutionContext context, [ScriptArgumentType(ScriptArgumentType.Music)] string trackName, bool fadeOut, bool fadeIn)
    {
    ...
    public static void PlaySpeechFile(ScriptExecutionContext context, [ScriptArgumentType(ScriptArgumentType.Dialog)] string speechName, bool overlap)
    {
