...
namespace OpenSage.Logic.Object
{
    ...
    /// </summary>
    public sealed class BeaconClientUpdate : ClientUpdate
    {
        internal static BeaconClientUpdate Parse(IniParser parser) => parser.ParseBlock(FieldParseTable);

        internal static readonly IniParseTable<BeaconClientUpdate> FieldParseTable = new IniParseTable<BeaconClientUpdate>
        {
