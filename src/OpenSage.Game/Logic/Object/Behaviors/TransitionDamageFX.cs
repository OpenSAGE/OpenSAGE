...
{
    public sealed class TransitionDamageFX : ObjectBehavior
    {
        internal static TransitionDamageFX Parse(IniParser parser) => parser.ParseBlock(FieldParseTable);

        private static readonly IniParseTable<TransitionDamageFX> FieldParseTable = new IniParseTable<TransitionDamageFX>
        {
