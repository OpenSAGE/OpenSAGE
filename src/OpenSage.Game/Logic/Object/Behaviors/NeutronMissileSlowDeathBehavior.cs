...
{
    public sealed class NeutronMissileSlowDeathBehaviorModuleData : SlowDeathBehaviorModuleData
    {
        internal static new NeutronMissileSlowDeathBehaviorModuleData Parse(IniParser parser) => parser.ParseBlock(FieldParseTable);

        private static new readonly IniParseTable<NeutronMissileSlowDeathBehaviorModuleData> FieldParseTable = SlowDeathBehaviorModuleData.FieldParseTable
            .Concat(new IniParseTable<NeutronMissileSlowDeathBehaviorModuleData>
            {
