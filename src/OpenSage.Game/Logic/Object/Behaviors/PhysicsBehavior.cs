...
public class PhysicsBehaviorModuleData : UpdateModuleData
{
    ...
    internal static readonly IniParseTable<PhysicsBehaviorModuleData> FieldParseTable = new IniParseTable<PhysicsBehaviorModuleData>
    {
        ...
        { "ForwardFriction", (parser, x) => x.ForwardFriction = parser.ParsePerSecondFloat() },
        { "LateralFriction", (parser, x) => x.LateralFriction = parser.ParsePerSecondFloat() },
        { "ZFriction", (parser, x) => x.ZFriction = parser.ParsePerSecondFloat() },
        { "AerodynamicFriction", (parser, x) => x.AerodynamicFriction = parser.ParsePerSecondFloat() },
