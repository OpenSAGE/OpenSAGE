...
namespace OpenSage.Logic.Object
{
    ...
    /// manner.
    /// </summary>
    public sealed class RailedTransportContainBehavior : ObjectBehavior
    {
        internal static RailedTransportContainBehavior Parse(IniParser parser) => parser.ParseBlock(FieldParseTable);

        private static readonly IniParseTable<RailedTransportContainBehavior> FieldParseTable = new IniParseTable<RailedTransportContainBehavior>
        {
