...
layout(set = 0, binding = 5) readonly buffer _SkinningBuffer
{
    mat4 SkinningBuffer[];
};
...
void main()
{
    ...
    out_WorldTangent = TransformNormal(in_Tangent, RenderItemConstantsVS.World);
    out_WorldBinormal = TransformNormal(in_Binormal, RenderItemConstantsVS.World);
}