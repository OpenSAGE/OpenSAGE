...
{
    public class SkirmishManager_old
    {
        ...
        public class SkirmishClient
        {
            ...
            private SkirmishManager_old _manager;
            ...
            public SkirmishClient(SkirmishManager_old manager, TcpClient client)
            {
                _manager = manager;
                _client = client;
            }
        ...
        public SkirmishManager_old(Game game)
        {
            _game = game;
