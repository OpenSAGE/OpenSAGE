...
namespace OpenZH.Data.Ini
{
    public sealed class ParticleSystem
    {
        ...
        private static readonly IniParseTable<ParticleSystem> FieldParseTable = new IniParseTable<ParticleSystem>
        {
            ...
            { "ParticleName", (parser, x) => x.ParticleName = parser.ParseAsciiString() },
            ...
            { "PerParticleAttachedSystem", (parser, x) => x.PerParticleAttachedSystem = parser.ParseAsciiString() },
            { "SlaveSystem", (parser, x) => x.SlaveSystem = parser.ParseAsciiString() },
