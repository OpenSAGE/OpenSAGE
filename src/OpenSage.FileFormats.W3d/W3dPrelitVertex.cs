...
public sealed record W3dPrelitVertex(
    W3dMaterialInfo MaterialInfo,
    W3dVertexMaterials? VertexMaterials,
    W3dShaders? Shaders,
    W3dTextures? Textures,
    W3dMaterialPass? MaterialPass1,
    W3dMaterialPass? MaterialPass2) : W3dPrelitBase(W3dChunkType.W3D_CHUNK_PRELIT_VERTEX, MaterialInfo, VertexMaterials,
    Shaders, Textures, MaterialPass1, MaterialPass2)
{
    internal static W3dPrelitVertex Parse(BinaryReader reader, W3dParseContext context)
    {
        return ParseChunk(reader, context, header =>
        {
            ...
            return new W3dPrelitVertex(w3dMaterialInfo, w3dVertexMaterials, w3dShaders, w3dTextures, w3dMaterialPass, materialPass2);
        });
    }
}
