...
public sealed record W3dAggregateHeader(uint Version, string Name) : W3dChunk(W3dChunkType.W3D_CHUNK_AGGREGATE_HEADER)
{
    internal static W3dAggregateHeader Parse(BinaryReader reader, W3dParseContext context)
    {
        return ParseChunk(reader, context, header =>
        {
            ...
            return new W3dAggregateHeader(version, name);
        });
    }
