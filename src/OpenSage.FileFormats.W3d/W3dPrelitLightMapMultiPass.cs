...
public sealed record W3dPrelitLightMapMultiPass(
    ...
    : W3dPrelitBase(W3dChunkType.W3D_CHUNK_PRELIT_LIGHTMAP_MULTI_PASS, MaterialInfo, VertexMaterials, Shaders, Textures,
        MaterialPass1, MaterialPass2)
{
    internal static W3dPrelitLightMapMultiPass Parse(BinaryReader reader, W3dParseContext context)
    {
        return ParseChunk(reader, context, header =>
        {
            ...
            return new W3dPrelitLightMapMultiPass(w3dMaterialInfo, w3dVertexMaterials, w3dShaders, w3dTextures, w3dMaterialPass, materialPass2);
        });
    }
}
