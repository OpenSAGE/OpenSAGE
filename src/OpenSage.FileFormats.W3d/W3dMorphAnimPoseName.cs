...
public sealed record W3dMorphAnimPoseName(byte[] UnknownBytes) : W3dChunk(W3dChunkType.W3D_CHUNK_MORPHANIM_POSENAME)
{
    internal static W3dMorphAnimPoseName Parse(BinaryReader reader, W3dParseContext context)
    {
        return ParseChunk(reader, context, header =>
        {
            ...
            return new W3dMorphAnimPoseName(unknownBytes);
        });
    }
