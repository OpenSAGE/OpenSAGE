...
namespace OpenSage.Graphics.Animation
{
    public sealed class AnimationInstance
    {
        ...
        public AnimationInstance(ModelBoneInstance[] modelBoneInstances, W3DAnimation animation, AnimationMode mode, bool startAtEnd)
        {
        ...
        public void SetTime(TimeSpan currentTimeValue)
        {
